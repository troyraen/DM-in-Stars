...
nohup nice ./bash_scripts/run_osirisRTT.sh ${run_key} &>> STD1_nohup_RTT.out &
nohup nice ./bash_scripts/run_osirisRTT.sh ${run_key} &>> STD2_nohup_RTT.out &
nohup nice ./bash_scripts/run_osirisRTT.sh ${run_key} &>> STD3_nohup_RTT.out &
